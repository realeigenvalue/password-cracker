...
EXES_APPLICATION=$(EXE_CRACKER1) $(EXE_CRACKER2)
...
release: $(EXES_APPLICATION) $(EXES_PROVIDED)
debug:   clean $(EXES_APPLICATION:%=%-debug) $(EXES_PROVIDED)
tsan:    clean $(EXES_APPLICATION:%=%-tsan) $(EXES_PROVIDED)
